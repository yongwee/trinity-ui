export default {
  ...
  fxTokenOpenPosition: {
    ...
    createTokenCurrencyCodeError: 'Please provide a value for currency code',
    createTokenAmountError: 'Please provide a value for amount',
  ...
  spToken: {
    ...
    createTokenNotionalAmountInput: 'Notional Amount',
    ...
    createTokenMaturityDateInput: 'Maturity Date',
    ...
    createTokenMaturityDateInputSuffix: 'year(s)',
    ...
    createTokenNotionalAmountInputError: 'Please provide a value for notional amount',
    createTokenIndicativeSpotPriceInputError: 'Please provide a value for indicative spot prive',
    createTokenStrikeRateInputError: 'Please provide a value for strike price',
    createTokenKnockOutPriceInputError: 'Please provide a value for knock out price',
    createTokenMaturityDateInputError: 'Please provide a value for maturity date',
